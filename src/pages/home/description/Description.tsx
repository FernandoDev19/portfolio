...
export default function Description() {
  ...
  const { ref: leftRef, isVisible: leftVisible } =
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row lg:items-center lg:justify-between w-full gap-8 lg:gap-12 mt-10 mb-12 md:mb-24">
      ...
      >
        ...
        {/* Botones */}
        <div className="flex justify-center md:justify-start items-center gap-4 mb-8 lg:mb-0 md:mx-0">
          <a
            href="https://github.com/FernandoDev19"
