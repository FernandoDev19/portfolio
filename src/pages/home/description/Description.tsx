  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row lg:items-center lg:justify-between w-full gap-8 lg:gap-12 mb-24">
      ...
      <div className="flex flex-col lg:flex-1">
        {/* Título principal */}
        <h1
          className="text-4xl md:text-5xl lg:text-6xl text-center md:text-left font-bold text-neutral-600 mb-2"
        ...
        {/* Subtítulo */}
        <h2
          className="text-4xl md:text-5xl lg:text-6xl text-center md:text-left font-bold text-neutral-600 mb-6"
          style={{ lineHeight: "0.9" }}
        >
        ...
        {/* Descripción */}
        <p className="text-neutral-400 text-center md:text-left mb-8 max-w-md">
      ...
      <div className="flex flex-col items-center lg:items-end lg:flex-shrink-0">
        ...
        {/* Social links */}
        <div className="p-3 rounded-full w-full max-w-[300px] lg:max-w-[300px] flex justify-evenly gap-4 mb-4 bg-white/50 shadow-md">
